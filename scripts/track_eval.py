...
AI_UP_MIN = 54      # 추적 4분면 'AI 상승' 분류 임계. 사이트 방향배지(ai.ts PROB_BULL_MIN=54,
# 2026-06-20 58→54 하향)와 동일 — Kimi가 보수적이라 58 기준이면 ai_up 분면이 비어 룰vsAI 비교 불가.
# radar_backtest·ai_click_eval도 54로 통일. 표본 누적 후 상대순위 방식 재검토 후보.
HIGH3_X = 1.03
