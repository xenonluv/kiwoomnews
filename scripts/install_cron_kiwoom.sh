...
# 최종 흔들기 익일 +7/-5 최초터치 — KRX 장마감 후 독립 수집·판정(운영 매매/순위 무관).
40 15 * * 1-5 cd $REPO && PYTHONUTF8=1 ${PY} scripts/shakeout_next_day_first_touch.py >> /tmp/kiwoom_shakeout_first_touch.log 2>&1
